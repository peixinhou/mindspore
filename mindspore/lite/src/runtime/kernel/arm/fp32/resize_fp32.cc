...
using mindspore::schema::CoordinateTransformMode_COMMON;
using mindspore::schema::CoordinateTransformMode_HALF_PIXEL;
using mindspore::schema::CoordinateTransformMode_PYTORCH_HALF_PIXEL;
using mindspore::schema::CoordinateTransformMode_TF_HALF_PIXEL;
...
int ResizeCPUKernel::RunImpl(int task_id) {
  ...
  CHECK_IF_NULL(context_, RET_NULL_PTR)
  CHECK_IF_NULL(input_data, RET_NULL_PTR)
  CHECK_IF_NULL(output_data, RET_NULL_PTR)
...
int ResizeCPUKernel::SelectCalculatorFunc() {
  std::map<int, CalculateOriginalCoordinate> cal_fuc_list = {
    std::make_pair(CoordinateTransformMode_COMMON, CalculateAsymmetric),
    ...
    std::make_pair(CoordinateTransformMode_PYTORCH_HALF_PIXEL, CalculateHalfPixel),
    std::make_pair(CoordinateTransformMode_TF_HALF_PIXEL, CalculateHalfPixel),
